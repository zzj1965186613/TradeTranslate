...
const PROMPTS = {
  en2zh: "You are a professional translator. Translate the following English text into natural, fluent Simplified Chinese. Preserve tone (casual, formal, technical). Only respond with the translation — no explanations, no notes.",
  zh2en: "You are a professional translator. Translate the following Chinese text into natural, fluent English. Preserve tone (casual, formal, technical). Only respond with the translation — no explanations, no notes."
};
